...
## 參考資料
Stack overflow: [Split a column of concatenated comma-delimited data and recode output as factors](https://stackoverflow.com/questions/10100887/split-a-column-of-concatenated-comma-delimited-data-and-recode-output-as-factors)
